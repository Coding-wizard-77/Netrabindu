import pytest
from services.camera_registry.models import WatchlistEntity, WatchlistAlias
from services.watchlist.matcher import watchlist_matcher, calculate_similarity, levenshtein_distance
