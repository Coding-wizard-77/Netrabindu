...
export const Drawer: React.FC<DrawerProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end bg-black/60 backdrop-blur-xs">
      ...
      <div
        className={clsx(
          'relative w-full h-full bg-white dark:bg-[#0f172a] border-l border-slate-200 dark:border-slate-800 shadow-2xl flex flex-col z-10 animate-in slide-in-from-right duration-300',
          widthClasses[width]
        )}
      >
        {/* Header */}
