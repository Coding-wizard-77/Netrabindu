...
class YOLOLikeDetector(BaseDetector):
    ...
    This is intentionally lightweight: it exposes the same contract used by the
    adaptive AI pipeline while keeping the implementation free of external model
    dependencies. It can be swapped for a real ONNX/YOLO runtime later without
